...
# Gemiddelde score per continent
happy['Score_continent'] = happy.groupby('Continent')['Score'].transform('mean')
...
if selected == 'Kaart':
    ...
    dropdown_buttons = [
        ...
        'args':[{'visible':[True, False, False, False, False, False, False, False]}, {'title':'Gelukkigheidsscore van de wereld'}]},
        {'label': 'Europa', 'method':'update',
        'args':[{'visible':[False, True, False, False, False, False, False, False]}, {'title':'Gelukkigheidsscore van Europa'}]},
        {'label': 'Oceanië', 'method':'update',
        'args':[{'visible':[False, False, True, False, False, False, False, False]}, {'title':'Gelukkigheidsscore van Oceanië'}]},
        {'label': 'Noord Amerika', 'method':'update',
        'args':[{'visible':[False, False, False, True, False, False, False, False]}, {'title':'Gelukkigheidsscore van Noord Amerika'}]},
        {'label': 'Zuid Amerika', 'method':'update',
        'args':[{'visible':[False, False, False, False, True, False, False, False]}, {'title':'Gelukkigheidsscore van Zuid Amerika'}]},
        {'label': 'Azië', 'method':'update',
        'args':[{'visible':[False, False, False, False, False, True, False, False]}, {'title':'Gelukkigheidsscore van Azië'}]},
        {'label': 'Afrika', 'method':'update',
        'args':[{'visible':[False, False, False, False, False, False, True, False]}, {'title':'Gelukkigheidsscore van frika'}]},
        {'label': 'Gem continenten', 'method':'update',
        'args':[{'visible':[False, False, False, False, False, False, False, True]}, {'title':'gmiddelde gelukkigheidsscore per continent'}]}
    ]
...
if selected == 'Regressie':
    ...
    # Residuen plot
    st.header('Residuenplot')
    figresid = plt.figure(figsize=(8, 3))
    sns.residplot(x='Healthy_life_expectancy', y='Score', data=happy)
    st.pyplot(figresid)
    st.write('In dit residuenplot is te zien dat er geen onderling verband zit, waardoor het een goed lineair model is')
